...
/* harmony import */ var _clouddata_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clouddata.svg */ "./src/components/tw-cloud-variable-badge/clouddata.svg");
/* harmony import */ var _clouddata_svg__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_clouddata_svg__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _cloud_variable_badge_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cloud-variable-badge.css */ "./src/components/tw-cloud-variable-badge/cloud-variable-badge.css");
/* harmony import */ var _cloud_variable_badge_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_cloud_variable_badge_css__WEBPACK_IMPORTED_MODULE_3__);
...
, {
  defaultMessage: "This project uses cloud variables. Scrooch3 uses its own cloud variable server independent of Scratch. Beware of impersonation as anyone can change their username to anything. {learnMore}",
...
if (window.parent !== window) {
  ...
  alert('This page is embedding Scrooch3/TurboWarp in a way that is unsupported and will cease to function in the near future. Please read https://docs.turbowarp.org/embedding');
...
// eslint-disable-next-line max-len
, {
  defaultMessage: "Scrooch3 and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation.",
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  handleUpdateProjectTitle(title, isDefault) {
    if (isDefault || !title) {
      document.title = "Scrooch3 - ".concat(this.props.intl.formatMessage(messages.defaultTitle));
    } else {
      document.title = "".concat(title, " - Scrooch3");
    }
  }
  render() {
    const _this$props = this.props,
    ...
    })), (description.instructions === 'unshared' || description.credits === 'unshared') && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"]
    // eslint-disable-next-line max-len
    , {
    ...
    // eslint-disable-next-line max-len
    , {
      defaultMessage: "Scrooch3 is a mod of TurboWarp to add new blocks and features. TurboWarp is a Scratch mod that compiles projects to JavaScript to make them run really fast. Try it out by inputting a project ID or URL above or choosing a featured project below.",
