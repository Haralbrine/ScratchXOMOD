...
, {
  defaultMessage: "This project uses cloud variables. XOMOD uses its own cloud variable server independent of Scratch. Beware of impersonation as anyone can change their username to anything. {learnMore}",
...
if (window.parent !== window) {
  ...
  alert('This page is embedding XOMOD/TurboWarp in a way that is unsupported and will cease to function in the near future. Please read https://docs.turbowarp.org/embedding');
...
// eslint-disable-next-line max-len
, {
  defaultMessage: "XOMOD and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation.",
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  handleUpdateProjectTitle(title, isDefault) {
    if (isDefault || !title) {
      document.title = "XOMOD - ".concat(this.props.intl.formatMessage(messages.defaultTitle));
    } else {
      document.title = "".concat(title, " - XOMOD");
    }
  }
  render() {
    const _this$props = this.props,
    ...
    // eslint-disable-next-line max-len
    , {
      defaultMessage: "XOMOD is a Scratch Mod powered by Scrooch 3. Try it out by inputting a project ID or URL above or choosing a featured project below.",
